...
import { BoundaryError, emptyIntent, parseConfig } from "../src/model.js";
import type { Config, Intent } from "../src/model.js";
import { Files, Processes } from "../src/io.js";
import { DnsInventory } from "../src/dns.js";
import { IntentStore } from "../src/state.js";
          ...
          Effect.gen(function* () {
            if (yield* Ref.get(failSave))
              return yield* Effect.fail(
                new BoundaryError({ code: "intent-save-failed" }),
              );
